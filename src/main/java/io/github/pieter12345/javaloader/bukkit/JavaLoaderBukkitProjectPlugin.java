 ...
 * This class is a highly modified copy of class "org.bukkit.plugin.java.JavaPlugin".
 */
public class JavaLoaderBukkitProjectPlugin extends PluginBase {
	...
	private final JavaLoaderBukkitProject projectInstance;
	
	// Custom constructor to create a JavaLoaderBukkitProjectPlugin for a given JavaProject.
	public JavaLoaderBukkitProjectPlugin(JavaProject project) {
...
//	}
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		// Call the onCommand method in the project instance.
		return this.projectInstance.onCommand(sender, command, label, args);
	}
	...
	public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
		// Call the onTabComplete method in the project instance.
		return this.projectInstance.onTabComplete(sender, command, alias, args);
	}
